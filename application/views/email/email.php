																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;"><p>Follow this link to verify your <b>Test Project </b> Subscription <a style="color:#15c"  href=""><?php echo strtolower($email); ?>,</a> account.</p>
																					<p><a style="color:#15c" target="_blank" href="<?php echo $token; ?>"><?php echo $token; ?> </a></p>
																					<p>If you did't want to create your account, you can ignore this email.</p>
																					<p>Thanks</p>
																					</div>
																				</td>
																			</tr>
