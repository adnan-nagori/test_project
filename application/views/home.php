				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<form id="subscribe_form" method="POST" action="" name="subscribe_form">
								<input class="input" type="email" id="email" name="email" placeholder="Enter Your Email">
								<button class="newsletter-btn" value="submit" name="submit" type="submit"><i class="fa fa-envelope"></i> Subscribe</button>
							</form>
